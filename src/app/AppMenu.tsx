...
import { SignInDialog } from "../features/auth/SignInAction";
...
export function AppMenu({
  ...
  return (
    <>
          ...
          <Dialog className={styles.dialog} aria-label={t("menu.label")}>
            ...
            <div className={styles.accountSection}>
              ...
              {customer ? (
                ...
                <Button slot="close" tone="quiet" onPress={() => setIsSignInOpen(true)}>
                  {t("auth.signIn")}
                </Button>
              ) : (
      ...
      <SignInDialog isOpen={isSignInOpen} onOpenChange={setIsSignInOpen} onSignIn={onSignIn} />
    </>
  );
}
